...
#' If a number, the depth to consider when fetching datapoints, if the value is positive then it is interpreted as a duration, if it is negative then as the maximum number of datapoints to fetch.
